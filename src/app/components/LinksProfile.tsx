...
export default function LinksProfile() {
    return (
        <div className="bg-profile-grey-800 flex flex-col justify-center items-center p-10 gap-4 max-w-sm w-full rounded-custom-lg">
            <Image src={userProfile.avatar} alt={userProfile.name} className="rounded-full" width={85} height={85} />
